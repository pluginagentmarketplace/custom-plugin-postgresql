...
This guide provides comprehensive documentation for the **postgresql-docker** skill in the custom-plugin-postgresql plugin.
...
```bash
# Invoke the skill
claude "postgresql-docker - [your task description]"

# Example
claude "postgresql-docker - analyze the current implementation"
```
...
def implement_postgresql_docker(input_data):
    """
    Implement postgresql-docker functionality.
