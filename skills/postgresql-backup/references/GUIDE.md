...
This guide provides comprehensive documentation for the **postgresql-backup** skill in the custom-plugin-postgresql plugin.
...
```bash
# Invoke the skill
claude "postgresql-backup - [your task description]"

# Example
claude "postgresql-backup - analyze the current implementation"
```
...
def implement_postgresql_backup(input_data):
    """
    Implement postgresql-backup functionality.
