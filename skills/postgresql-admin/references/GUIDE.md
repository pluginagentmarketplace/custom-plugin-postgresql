...
This guide provides comprehensive documentation for the **postgresql-admin** skill in the custom-plugin-postgresql plugin.
...
```bash
# Invoke the skill
claude "postgresql-admin - [your task description]"

# Example
claude "postgresql-admin - analyze the current implementation"
```
...
def implement_postgresql_admin(input_data):
    """
    Implement postgresql-admin functionality.
