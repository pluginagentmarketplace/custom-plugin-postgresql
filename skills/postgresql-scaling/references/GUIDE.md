...
This guide provides comprehensive documentation for the **postgresql-scaling** skill in the custom-plugin-postgresql plugin.
...
```bash
# Invoke the skill
claude "postgresql-scaling - [your task description]"

# Example
claude "postgresql-scaling - analyze the current implementation"
```
...
def implement_postgresql_scaling(input_data):
    """
    Implement postgresql-scaling functionality.
