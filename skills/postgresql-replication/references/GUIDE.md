...
This guide provides comprehensive documentation for the **postgresql-replication** skill in the custom-plugin-postgresql plugin.
...
```bash
# Invoke the skill
claude "postgresql-replication - [your task description]"

# Example
claude "postgresql-replication - analyze the current implementation"
```
...
def implement_postgresql_replication(input_data):
    """
    Implement postgresql-replication functionality.
