...
This guide provides comprehensive documentation for the **postgresql-monitoring** skill in the custom-plugin-postgresql plugin.
...
```bash
# Invoke the skill
claude "postgresql-monitoring - [your task description]"

# Example
claude "postgresql-monitoring - analyze the current implementation"
```
...
def implement_postgresql_monitoring(input_data):
    """
    Implement postgresql-monitoring functionality.
