...
This guide provides comprehensive documentation for the **postgresql-json** skill in the custom-plugin-postgresql plugin.
...
```bash
# Invoke the skill
claude "postgresql-json - [your task description]"

# Example
claude "postgresql-json - analyze the current implementation"
```
...
def implement_postgresql_json(input_data):
    """
    Implement postgresql-json functionality.
