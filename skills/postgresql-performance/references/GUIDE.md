...
This guide provides comprehensive documentation for the **postgresql-performance** skill in the custom-plugin-postgresql plugin.
...
```bash
# Invoke the skill
claude "postgresql-performance - [your task description]"

# Example
claude "postgresql-performance - analyze the current implementation"
```
...
def implement_postgresql_performance(input_data):
    """
    Implement postgresql-performance functionality.
