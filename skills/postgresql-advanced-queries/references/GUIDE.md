...
This guide provides comprehensive documentation for the **postgresql-advanced-queries** skill in the custom-plugin-postgresql plugin.
...
```bash
# Invoke the skill
claude "postgresql-advanced-queries - [your task description]"

# Example
claude "postgresql-advanced-queries - analyze the current implementation"
```
...
def implement_postgresql_advanced_queries(input_data):
    """
    Implement postgresql-advanced-queries functionality.
